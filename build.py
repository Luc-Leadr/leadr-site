...
def render_footer():
    cols = []
    logo_col = '''<div>
        <a href="index.html" class="logo footer-logo"><img src="logo2.png" alt="Leadr" class="logo-img"></a>
...
<header class="site-header">
  <nav class="nav-bar">
    <a href="index.html" class="logo"><img src="logo.png" alt="Leadr" class="logo-img"></a>
...
index_content = '''
  ...
  <section class="section-border-top section-tint">
    <div class="container">
      <div class="section-head">
